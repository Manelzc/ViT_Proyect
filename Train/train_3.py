...
# Cargar los pesos preentrenados (comentar si hay que entrenear de 0)
#model.load_state_dict(torch.load("/content/drive/MyDrive/ViT_proyect/models/best_model_6_20_LR.pth"))
...
BEST_MODEL_PATH = "/content/drive/MyDrive/ViT_proyect/models/best_model_6_20_LR.pth"
